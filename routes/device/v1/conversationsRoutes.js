 ...
 * @description :: CRUD API routes for conversations
 */

const express = require('express');
const router = express.Router();
const conversationsController = require('../../../controller/device/v1/conversationsController');
...
router.route('/device/api/v1/conversations/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,conversationsController.getConversations);
