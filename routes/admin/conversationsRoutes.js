...
const conversationsController = require('../../controller/admin/conversationsController');
...
router.route('/admin/conversations/:id').get(auth(PLATFORM.ADMIN),checkRolePermission,conversationsController.getConversations);
